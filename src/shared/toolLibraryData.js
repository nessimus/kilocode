...
export const additionalToolLibraryItems = [
    {
        ...
        author: "Anthropic",
        description: "Control a locally running Chrome instance through the Model Context Protocol to drive websites, fill forms, and capture DOM data for automation tasks.",
        codiconIcon: "globe",
    ...
    },
    {
        ...
        author: "puran-water",
        description: "Provides Model Context Protocol access to AutoCAD for opening drawings, running commands, and exporting assets from DWG projects.",
        codiconIcon: "tools",
    ...
    },
    {
        ...
        author: "Zapier",
        description: "Triggers and searches across 6,000+ Zapier connectors through an MCP tool that exposes Zapier Platform APIs to agents.",
        codiconIcon: "zap",
    ...
    },
    {
        ...
        author: "Google",
        description: "REST and gRPC APIs to read, write, and format spreadsheets; ideal for a future MCP server or direct computer use fallback.",
        codiconIcon: "table",
        logoUrl: "https://logo.clearbit.com/google.com",
    ...
    },
    {
        ...
        author: "Browserbase",
        description: "Provision headless Chromium sessions in Browserbase's cloud to automate complex web apps with persistent storage, screenshots, and network control.",
        codiconIcon: "cloud",
    ...
    },
    {
        ...
        author: "Roboflow",
        description: "Programmatic dataset management, training, and inference for computer vision models; candidates for an MCP wrapper or Zapier automation.",
        codiconIcon: "eye",
    ...
    },
    {
        ...
        author: "1Password",
        description: "Self-hosted Connect server exposes vault items over a REST API; use it to retrieve credentials for downstream tools.",
        codiconIcon: "shield",
    ...
    },
    {
        ...
        author: "Postman",
        description: "Manage Postman workspaces, collections, environments, and monitors programmatically; a good candidate for an MCP wrapper to keep API tests in sync.",
        codiconIcon: "beaker",
    ...
    },
    {
        ...
        author: "Product Hunt",
        description: "GraphQL API for posting launches, fetching featured products, and monitoring community engagement.",
        codiconIcon: "rocket",
    ...
    },
    {
        ...
        author: "Gumroad",
        description: "Manage products, generate license keys, and process refunds programmatically for Gumroad storefronts.",
    ...
    },
    {
        ...
        author: "tanob",
        description: "Simulate keyboard and mouse actions on the host OS to drive GUI-only software, capture screens, and script workflows that lack APIs.",
...
//# sourceMappingURL=toolLibraryData.js.map