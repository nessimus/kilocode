...
describe("Text normalization utilities", () => {
    describe("normalizeString", () => {
        it("normalizes smart quotes by default", () => {
            expect(normalizeString("These are \u201Csmart quotes\u201D and \u2018single quotes\u2019")).toBe("These are \"smart quotes\" and 'single quotes'");
        });
        it("normalizes typographic characters by default", () => {
            expect(normalizeString("This has an em dash \u2014 and ellipsis\u2026")).toBe("This has an em dash - and ellipsis...");
        });
        ...
        it("can be configured to skip certain normalizations", () => {
            ...
            expect(normalizeString(input, { smartQuotes: false })).toBe("Keep \u201Csmart quotes\u201D but normalize whitespace");
        });
    ...
    describe("unescapeHtmlEntities", () => {
        ...
        it("unescapes quote entities", () => {
            expect(unescapeHtmlEntities("&quot;quoted&quot; and &#39;single-quoted&#39;")).toBe("\"quoted\" and 'single-quoted'");
        });
        ...
        it("handles mixed content with multiple entity types", () => {
            expect(unescapeHtmlEntities("&lt;a href=&quot;https://example.com?param1=value&amp;param2=value&quot;&gt;Link&lt;/a&gt;")).toBe('<a href="https://example.com?param1=value&param2=value">Link</a>');
        });
        it("handles mixed content with apostrophe entities", () => {
            expect(unescapeHtmlEntities("&lt;div&gt;Don&apos;t forget that Tom&amp;Jerry&apos;s show is at 3 o&apos;clock&lt;/div&gt;")).toBe("<div>Don't forget that Tom&Jerry's show is at 3 o'clock</div>");
        });
        ...
        it("handles empty or undefined input", () => {
            ...
            expect(unescapeHtmlEntities(undefined)).toBe(undefined);
        });
    });
});
//# sourceMappingURL=text-normalization.spec.js.map