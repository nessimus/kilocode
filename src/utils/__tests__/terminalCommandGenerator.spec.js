...
vi.mock("../../i18n", () => ({
    t: vi.fn((key, params) => {
        const translations = {
            ...
            "kilocode:terminalCommandGenerator.inputPlaceholder": "e.g., kill the process running on port 3001, find large files, etc",
            "kilocode:terminalCommandGenerator.noActiveTerminal": "No active terminal found. Please open a terminal first.",
            ...
            "kilocode:terminalCommandGenerator.warningDialog.message": "This command was generated by AI and may not be accurate. Terminal actions cannot be undone—once executed, changes are permanent. Running unverified commands can result in irreversible data loss, security issues, or system damage. Review and understand the command completely before proceeding!",
...
describe("generateTerminalCommand", () => {
    ...
    it("should handle missing active terminal", async () => {
        ...
        expect(vscode.window.showErrorMessage).toHaveBeenCalledWith("No active terminal found. Please open a terminal first.");
        expect(singleCompletionHandler).not.toHaveBeenCalled();
    });
    it("should handle API configuration errors", async () => {
        ...
        expect(vscode.window.showErrorMessage).toHaveBeenCalledWith(expect.stringContaining("Failed to generate command:"));
    });
    describe("warning dialog functionality", () => {
        it("should show warning dialog on first use", async () => {
            ...
            expect(vscode.window.showInformationMessage).toHaveBeenCalledWith(expect.stringContaining("Always Verify AI-Generated Commands"), expect.objectContaining({ modal: true }), "OK, I Understand", "Cancel");
