...
describe("autoImportSettings", () => {
    ...
    it("should skip auto-import when no settings path is specified", async () => {
        ...
        expect(mockOutputChannel.appendLine).toHaveBeenCalledWith("[AutoImport] No auto-import settings path specified, skipping auto-import");
    ...
    it("should skip auto-import when settings file does not exist", async () => {
        ...
        expect(mockOutputChannel.appendLine).toHaveBeenCalledWith("[AutoImport] Checking for settings file at: /home/user/Documents/roo-config.json");
        expect(mockOutputChannel.appendLine).toHaveBeenCalledWith("[AutoImport] Settings file not found at /home/user/Documents/roo-config.json, skipping auto-import");
        expect(mockProviderSettingsManager.import).not.toHaveBeenCalled();
    });
    it("should successfully import settings when file exists and is valid", async () => {
        ...
        expect(mockOutputChannel.appendLine).toHaveBeenCalledWith("[AutoImport] Checking for settings file at: /absolute/path/to/config.json");
        expect(mockOutputChannel.appendLine).toHaveBeenCalledWith("[AutoImport] Successfully imported settings from /absolute/path/to/config.json");
    ...
    it("should handle invalid JSON gracefully", async () => {
        ...
        expect(mockOutputChannel.appendLine).toHaveBeenCalledWith(expect.stringContaining("[AutoImport] Failed to import settings:"));
        expect(vscode.window.showWarningMessage).toHaveBeenCalledWith(expect.stringContaining("warnings.auto_import_failed"));
        expect(mockProviderSettingsManager.import).not.toHaveBeenCalled();
    });
    it("should resolve home directory paths correctly", async () => {
        ...
        expect(mockOutputChannel.appendLine).toHaveBeenCalledWith("[AutoImport] Checking for settings file at: /home/user/Documents/config.json");
    });
    ...
    it("should handle file system errors gracefully", async () => {
        ...
        expect(mockOutputChannel.appendLine).toHaveBeenCalledWith(expect.stringContaining("[AutoImport] Unexpected error during auto-import:"));
        expect(mockProviderSettingsManager.import).not.toHaveBeenCalled();
    });
});
//# sourceMappingURL=autoImportSettings.spec.js.map