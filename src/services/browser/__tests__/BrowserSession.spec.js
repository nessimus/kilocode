...
describe("BrowserSession", () => {
    ...
    describe("Remote browser disabled", () => {
        it("should launch a local browser when remote browser is disabled", async () => {
            ...
            expect(browserSession.isUsingRemoteBrowser).toBe(false);
        });
    });
    describe("Remote browser successfully connects", () => {
        it("should connect to a remote browser when enabled and connection succeeds", async () => {
            ...
            expect(browserSession.isUsingRemoteBrowser).toBe(true);
        });
    });
    ...
    describe("closeBrowser", () => {
        it("should close a local browser properly", async () => {
            ...
            browserSession.browser = mockBrowser;
            browserSession.page = {};
            browserSession.isUsingRemoteBrowser = false;
            ...
            expect(browserSession.browser).toBeUndefined();
            expect(browserSession.page).toBeUndefined();
            expect(browserSession.isUsingRemoteBrowser).toBe(false);
        });
        it("should disconnect from a remote browser properly", async () => {
            ...
            browserSession.browser = mockBrowser;
            browserSession.page = {};
            browserSession.isUsingRemoteBrowser = true;
            await browserSession.closeBrowser();
...
//# sourceMappingURL=BrowserSession.spec.js.map