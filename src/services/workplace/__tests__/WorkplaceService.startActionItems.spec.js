...
const buildActionStatus = (overrides) => ({
    id: "status",
    name: "Status",
    order: 0,
    isTerminal: false,
...
const buildActionItem = (overrides) => ({
    id: "action",
    companyId: "company-1",
    title: "Action",
    kind: "task",
...
const createMockContext = (initialState) => {
    ...
    const memento = {
        get: vi.fn((key) => (key === STORAGE_KEY ? state : undefined)),
...
//# sourceMappingURL=WorkplaceService.startActionItems.spec.js.map