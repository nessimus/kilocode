...
import { getGlobalRooDirectory, getProjectRooDirectoryForCwd, directoryExists, fileExists, readFileIfExists, getRooDirectoriesForCwd, loadConfiguration, } from "../index";
describe("RooConfigService", () => {
    ...
    describe("loadConfiguration", () => {
        ...
        it("should use correct file paths", async () => {
            ...
            expect(mockReadFile).toHaveBeenCalledWith(path.join("/project/path", ".kilocode", "rules/rules.md"), "utf-8");
        });
    });
});
