...
const VSCODE_TO_SHIKI_THEME_MAP = {
    // Dark themes
...
export function getVSCodeThemeName() {
    const workbenchConfig = vscode.workspace.getConfiguration();
    return workbenchConfig.get("workbench.colorTheme") ?? "Default Dark Modern";
}
...
//# sourceMappingURL=ThemeMapper.js.map