...
- Follow language-specific patterns`;
    ...
    getExpectedChildren(node) {
        ...
        if (node.children) {
            const existingTypes = node.children.map((c) => c.type);
    ...
    analyzeSiblings(node) {
        ...
        const incompleteSiblings = siblings.filter((s) => s.isMissing || s.hasError);
...
//# sourceMappingURL=ASTAwareStrategy.js.map