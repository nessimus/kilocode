...
- Consider the most likely next step`;
    ...
    buildUserPrompt(context) {
        ...
        if (context.document && context.range) {
            const surrounding = this.getSurroundingCode(context.document, context.range, 15, // More lines before
            10);
     ...
     */
    analyzeContext(surrounding, context) {
     ...
     */
    getContextualHints(document, range) {
     ...
     */
    getIndentationLevel(document, lineNum) {
     ...
     */
    isNearFunctionEnd(document, lineNum) {
...
//# sourceMappingURL=NewLineCompletionStrategy.js.map