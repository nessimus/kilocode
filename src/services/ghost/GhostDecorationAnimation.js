...
export class GhostDecorationAnimation {
    animationInitialWaitTimer = null;
    animationInterval = null;
    decorationType;
    animationState = 0;
    isTypingPhase = true; // Track whether we're in typing phase or blinking phase
    animationFrames = ["█", "K█", "KI█", "KIL█", "KILO█"];
    isBlockVisible = true; // For blinking effect when fully spelled
    editor = null;
    range = null;
    constructor() {
...
//# sourceMappingURL=GhostDecorationAnimation.js.map