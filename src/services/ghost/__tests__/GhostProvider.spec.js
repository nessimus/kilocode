...
describe("GhostProvider", () => {
    ...
    beforeEach(() => {
        ...
        vi.mocked(vscode.workspace.openTextDocument).mockImplementation(async (uri) => {
    ...
    async function setupTestDocument(filename, content) {
    ...
    async function parseAndApplySuggestions(response, context) {
    ...
    async function runFileBasedTest(testCaseName) {
...
//# sourceMappingURL=GhostProvider.spec.js.map