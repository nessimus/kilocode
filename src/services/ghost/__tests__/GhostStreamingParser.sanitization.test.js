...
describe("GhostStreamingParser - XML Sanitization", () => {
    ...
    beforeEach(() => {
        ...
        const mockDocument = {
            ...
            uri: { fsPath: "/test/file.ts", toString: () => "file:///test/file.ts" },
  ...
  const params = new URLSearchParams();`),
                uri: { fsPath: "/test/file.tsx", toString: () => "file:///test/file.tsx" },
...
//# sourceMappingURL=GhostStreamingParser.sanitization.test.js.map