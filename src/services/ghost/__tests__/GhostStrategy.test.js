    ...
    describe("Strategy Selection", () => {
        ...
        it("should select appropriate strategy based on context", () => {
            const mockDocument = {
                ...
                lineCount: 2,
                uri: { toString: () => "file:///test.ts" },
                offsetAt: (position) => (position.line === 1 ? 32 : 0),
            };
            const mockRange = {
    ...
    describe("Integration with PromptStrategyManager", () => {
        it("should properly integrate with strategy manager for all use cases", () => {
            const mockDocument = {
                languageId: "typescript",
                getText: () => "const x = 1;\n",
                lineAt: (line) => ({ text: line === 0 ? "const x = 1;" : "" }),
                lineCount: 2,
                uri: { toString: () => "file:///test.ts" },
                offsetAt: (position) => (position.line === 0 ? 13 : 14),
            };
...
//# sourceMappingURL=GhostStrategy.test.js.map