...
describe("RemoteConfigLoader", () => {
  ...
  - id: "test-mcp"
    ...
    content: '{"command": "test"}'`;
            ...
            expect(mockedAxios.get).toHaveBeenCalledWith("https://test.api.com/api/marketplace/modes", expect.objectContaining({
                timeout: 10000,
                headers: {
            ...
            expect(mockedAxios.get).toHaveBeenCalledWith("https://test.api.com/api/marketplace/mcps", expect.objectContaining({
                timeout: 10000,
                headers: {
                    Accept: "application/json",
                    "Content-Type": "application/json",
  ...
  - id: "test-mode"
    ...
    content: "test content"`;
        ...
        it("should throw error after max retries", async () => {
            ...
            expect(mockedAxios.get).toHaveBeenCalledWith(expect.stringContaining("/api/marketplace/"), expect.any(Object));
  ...
  - id: "target-mcp"
    ...
    content: "test content"`;
            ...
            const modeItem = await loader.getItem("target-mode", "mode");
            const mcpItem = await loader.getItem("target-mcp", "mcp");
            const notFound = await loader.getItem("nonexistent", "mode");
...
//# sourceMappingURL=RemoteConfigLoader.spec.js.map