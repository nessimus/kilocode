...
describe("FireworksHandler", () => {
    ...
    it("should use the correct Fireworks base URL", () => {
        ...
        expect(OpenAI).toHaveBeenCalledWith(expect.objectContaining({ baseURL: "https://api.fireworks.ai/inference/v1" }));
    });
    ...
    it("should handle errors in completePrompt", async () => {
        ...
        await expect(handler.completePrompt("test prompt")).rejects.toThrow(`Fireworks completion error: ${errorMessage}`);
    });
...
//# sourceMappingURL=fireworks.spec.js.map