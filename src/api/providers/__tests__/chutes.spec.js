...
import { chutesDefaultModelId, chutesModels, DEEP_SEEK_DEFAULT_TEMPERATURE } from "@roo-code/types";
...
describe("ChutesHandler", () => {
    ...
    it("should return DeepSeek V3.1 model with correct configuration", () => {
        const testModelId = "deepseek-ai/DeepSeek-V3.1";
        const handlerWithModel = new ChutesHandler({
            apiModelId: testModelId,
            chutesApiKey: "test-chutes-api-key",
        });
        const model = handlerWithModel.getModel();
        expect(model.id).toBe(testModelId);
        expect(model.info).toEqual(expect.objectContaining({
            maxTokens: 32768,
    ...
    it("should return Qwen3-235B-A22B-Instruct-2507 model with correct configuration", () => {
        const testModelId = "Qwen/Qwen3-235B-A22B-Instruct-2507";
        const handlerWithModel = new ChutesHandler({
            apiModelId: testModelId,
            chutesApiKey: "test-chutes-api-key",
        });
    ...
    it("should return zai-org/GLM-4.5-Air model with correct configuration", () => {
        const testModelId = "zai-org/GLM-4.5-Air";
        const handlerWithModel = new ChutesHandler({
            apiModelId: testModelId,
            chutesApiKey: "test-chutes-api-key",
        });
    ...
    it("should return zai-org/GLM-4.5-FP8 model with correct configuration", () => {
        const testModelId = "zai-org/GLM-4.5-FP8";
        const handlerWithModel = new ChutesHandler({
            apiModelId: testModelId,
            chutesApiKey: "test-chutes-api-key",
        });
    ...
    it("should return Qwen/Qwen3-Coder-480B-A35B-Instruct-FP8 model with correct configuration", () => {
        const testModelId = "Qwen/Qwen3-Coder-480B-A35B-Instruct-FP8";
        const handlerWithModel = new ChutesHandler({
            apiModelId: testModelId,
            chutesApiKey: "test-chutes-api-key",
        });
    ...
    it("should return Qwen/Qwen3-Next-80B-A3B-Instruct model with correct configuration", () => {
        const testModelId = "Qwen/Qwen3-Next-80B-A3B-Instruct";
        const handlerWithModel = new ChutesHandler({
            apiModelId: testModelId,
            chutesApiKey: "test-chutes-api-key",
        });
    ...
    it("should return Qwen/Qwen3-Next-80B-A3B-Thinking model with correct configuration", () => {
        const testModelId = "Qwen/Qwen3-Next-80B-A3B-Thinking";
        const handlerWithModel = new ChutesHandler({
            apiModelId: testModelId,
            chutesApiKey: "test-chutes-api-key",
        });
    ...
    it("should return moonshotai/Kimi-K2-Instruct-75k model with correct configuration", () => {
        const testModelId = "moonshotai/Kimi-K2-Instruct-75k";
        const handlerWithModel = new ChutesHandler({
            apiModelId: testModelId,
            chutesApiKey: "test-chutes-api-key",
        });
    ...
    it("should return moonshotai/Kimi-K2-Instruct-0905 model with correct configuration", () => {
        const testModelId = "moonshotai/Kimi-K2-Instruct-0905";
        const handlerWithModel = new ChutesHandler({
            apiModelId: testModelId,
            chutesApiKey: "test-chutes-api-key",
        });
    ...
    it("createMessage should pass correct parameters to Chutes client for DeepSeek R1", async () => {
        ...
        const messages = [{ role: "user", content: "Test message for Chutes" }];
    ...
    it("createMessage should pass correct parameters to Chutes client for non-DeepSeek models", async () => {
        const modelId = "unsloth/Llama-3.3-70B-Instruct";
...
//# sourceMappingURL=chutes.spec.js.map