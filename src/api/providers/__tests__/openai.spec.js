...
describe("OpenAiHandler", () => {
    ...
    describe("createMessage", () => {
        ...
        it("should omit temperature when modelTemperature is undefined", async () => {
            const optionsWithoutTemperature = {
                ...mockOptions,
        ...
        it("should include temperature when modelTemperature is explicitly set to 0", async () => {
            const optionsWithZeroTemperature = {
                ...mockOptions,
                modelTemperature: 0,
            };
        ...
        it("should include temperature when modelTemperature is set to a non-zero value", async () => {
            const optionsWithCustomTemperature = {
                ...mockOptions,
...
describe("getOpenAiModels", () => {
    ...
    it("should include authorization header when apiKey is provided", async () => {
        ...
        expect(axios.get).toHaveBeenCalledWith("https://api.example.com/v1/models", expect.objectContaining({
