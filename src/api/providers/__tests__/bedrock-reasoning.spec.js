...
describe("AwsBedrockHandler - Extended Thinking", () => {
    ...
    beforeEach(() => {
        ...
        mockSend = vi.fn();
        ConverseStreamCommand.mockImplementation((payload) => {
    ...
    describe("Extended Thinking Support", () => {
        ...
        it("should log when extended thinking is enabled", async () => {
            ...
            // Verify logging
            expect(logger.info).toHaveBeenCalledWith(expect.stringContaining("Extended thinking enabled"), expect.objectContaining({
                ctx: "bedrock",
...
//# sourceMappingURL=bedrock-reasoning.spec.js.map