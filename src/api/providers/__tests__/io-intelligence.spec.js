...
describe("IOIntelligenceHandler", () => {
    ...
    it("should handle errors in completePrompt", async () => {
        ...
        await expect(handler.completePrompt("test prompt")).rejects.toThrow(`IO Intelligence completion error: ${errorMessage}`);
    });
...
//# sourceMappingURL=io-intelligence.spec.js.map