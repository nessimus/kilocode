...
import { featherlessDefaultModelId, featherlessModels, DEEP_SEEK_DEFAULT_TEMPERATURE, } from "@roo-code/types";
...
describe("FeatherlessHandler", () => {
    ...
    it("should return specified model when valid model is provided", () => {
        const testModelId = "deepseek-ai/DeepSeek-R1-0528";
    ...
    it("createMessage should pass correct parameters to Featherless client for DeepSeek R1", async () => {
        ...
        const messages = [{ role: "user", content: "Test message for Featherless" }];
    ...
    it("should use default temperature for non-DeepSeek models", () => {
        const testModelId = "moonshotai/Kimi-K2-Instruct";
        const handlerWithModel = new FeatherlessHandler({
            apiModelId: testModelId,
            featherlessApiKey: "test-featherless-api-key",
        });
...
//# sourceMappingURL=featherless.spec.js.map