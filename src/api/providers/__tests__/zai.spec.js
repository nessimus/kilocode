...
import { internationalZAiDefaultModelId, mainlandZAiDefaultModelId, internationalZAiModels, mainlandZAiModels, } from "@roo-code/types";
...
describe("ZAiHandler", () => {
    ...
    describe("China Z AI", () => {
        ...
        it("should use the correct China Z AI base URL", () => {
            ...
            expect(OpenAI).toHaveBeenCalledWith(expect.objectContaining({ baseURL: "https://open.bigmodel.cn/api/paas/v4" }));
        });
    ...
    describe("API Methods", () => {
        ...
        it("should handle errors in completePrompt", async () => {
            ...
            await expect(handler.completePrompt("test prompt")).rejects.toThrow(`Z AI completion error: ${errorMessage}`);
        });
