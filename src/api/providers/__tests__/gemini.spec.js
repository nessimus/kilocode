...
describe("GeminiHandler", () => {
    ...
    describe("createMessage", () => {
        ...
        it("should handle text messages correctly", async () => {
            ...
            expect(handler["client"].models.generateContentStream).toHaveBeenCalledWith(expect.objectContaining({
    ...
    describe("completePrompt", () => {
        ...
        it("should handle API errors", async () => {
            ...
            await expect(handler.completePrompt("Test prompt")).rejects.toThrow(t("common:errors.gemini.generate_complete_prompt", { error: "Gemini API error" }));
        });
    ...
    describe("calculateCost", () => {
        ...
        it("should calculate cost correctly based on input and output tokens", () => {
            ...
            const expectedCost = (inputTokens / 1_000_000) * mockInfo.inputPrice + (outputTokens / 1_000_000) * mockInfo.outputPrice;
        ...
        it("should calculate cost with cache write tokens", () => {
            ...
            const expectedCacheWriteCost = mockInfo.cacheWritesPrice * (cacheWriteTokens / 1_000_000) * (CACHE_TTL / 60);
...
//# sourceMappingURL=gemini.spec.js.map