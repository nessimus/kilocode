...
OpenAI.mockImplementation = mockConstructor.mockReturnValue({
    chat: {
        completions: {
            create: mockCreate,
        },
...
describe("VercelAiGatewayHandler", () => {
    ...
    describe("completePrompt", () => {
        ...
        it("handles completion errors correctly", async () => {
            ...
            await expect(handler.completePrompt("Test")).rejects.toThrow(`Vercel AI Gateway completion error: ${errorMessage}`);
        });
