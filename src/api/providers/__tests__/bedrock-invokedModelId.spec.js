            ...
            return {
                stream: createMockStream([
                    // First event with invokedModelId and usage metadata
                    {
                        trace: {
                            promptRouter: {
                                invokedModelId: "arn:aws:bedrock:us-west-2:699475926481:inference-profile/us.anthropic.claude-2-1-v1:0",
                                usage: {
                                    inputTokens: 150,
                                    outputTokens: 250,
                                    cacheReadTokens: 0,
            ...
            return {
                stream: createMockStream([
                    // Event with valid invokedModelId
                    {
                        trace: {
                            promptRouter: {
                                invokedModelId: "arn:aws:bedrock:us-east-1:123456789:foundation-model/anthropic.claude-3-sonnet-20240229-v1:0",
                            },
                        },
                    },
                ]),
...
//# sourceMappingURL=bedrock-invokedModelId.spec.js.map