...
describe("Vercel AI Gateway Fetchers", () => {
    ...
    describe("getVercelAiGatewayModels", () => {
                ...
                data: [
                    {
                        ...
                        description: "Claude Sonnet 4 significantly improves on Sonnet 3.7's industry-leading capabilities",
        ...
        it("handles API errors gracefully", async () => {
            ...
            expect(consoleErrorSpy).toHaveBeenCalledWith(expect.stringContaining("Error fetching Vercel AI Gateway models"));
        ...
        it("handles invalid response schema gracefully", async () => {
            ...
            const models = await getVercelAiGatewayModels();
            expect(models).toEqual({});
            expect(consoleErrorSpy).toHaveBeenCalledWith("Vercel AI Gateway models response is invalid", expect.any(Object));
            consoleErrorSpy.mockRestore();
        });
    ...
    describe("parseVercelAiGatewayModel", () => {
        ...
        it("detects vision and tools models", () => {
            ...
            expect(result.supportsImages).toBe(VERCEL_AI_GATEWAY_VISION_AND_TOOLS_MODELS.has("anthropic/claude-sonnet-4"));
            expect(result.supportsComputerUse).toBe(VERCEL_AI_GATEWAY_VISION_AND_TOOLS_MODELS.has("anthropic/claude-sonnet-4"));
        });
