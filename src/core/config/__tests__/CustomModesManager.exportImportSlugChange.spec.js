...
describe("CustomModesManager", () => {
    ...
    describe("updateCustomMode", () => {
        it("should update mode in settings file while preserving .kilocodemodes precedence", async () => {
            ...
            expect(content.customModes).toContainEqual(expect.objectContaining({
                slug: "mode1",
                name: "Updated Mode 1",
                roleDefinition: "Updated Role 1",
                source: "global",
            ...
            expect(mockContext.globalState.update).toHaveBeenCalledWith("customModes", expect.arrayContaining([
        ...
        it("creates .kilocodemodes file when adding project-specific mode", async () => {
            ...
            expect(fs.writeFile).toHaveBeenCalledWith(expect.any(String), // Don't check exact path as it may have different separators on different platforms
            expect.stringContaining("project-mode"), "utf-8");
    ...
    describe("File Operations", () => {
        ...
        it("watches file for changes", async () => {
            ...
            arePathsEqual.mockImplementation((path1, path2) => path.normalize(path1) === path.normalize(path2));
    ...
    describe("updateModesInFile", () => {
        ...
        describe("importModeWithRules", () => {
            ...
            it("should successfully import mode without rules files", async () => {
                ...
                expect(fs.writeFile).toHaveBeenCalledWith(expect.stringContaining(".kilocodemodes"), expect.stringContaining("imported-mode"), "utf-8");
            });
            it("should successfully import mode with rules files", async () => {
                ...
                expect(fs.mkdir).toHaveBeenCalledWith(expect.stringContaining(path.join("rules-imported-mode", "subfolder")), { recursive: true });
            ...
            it("should prevent path traversal attacks in import", async () => {
                ...
                writtenRuleFiles.forEach((filePath) => {
                    ...
                    const expectedBasePath = path.normalize(getProjectRooDirectoryForCwd(mockWorkspacePath));
	...
	customModes:
            ...
            it("should remove existing rules folder when importing mode without rules", async () => {
                ...
                // Verify mode was imported
                expect(fs.writeFile).toHaveBeenCalledWith(expect.stringContaining(".kilocodemodes"), expect.stringContaining("test-mode"), "utf-8");
            });
...
//# sourceMappingURL=CustomModesManager.exportImportSlugChange.spec.js.map