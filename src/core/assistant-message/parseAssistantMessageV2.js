    ...
    for (let i = 0; i < len; i++) {
        ...
        if (currentToolUse && currentParamName) {
            ...
            if (currentCharIndex >= closeTag.length - 1 &&
                ...
                const value = assistantMessage.slice(currentParamValueStart, // Start after the opening tag.
        ...
        if (currentToolUse && !currentParamName) {
            ...
            if (currentCharIndex >= toolCloseTag.length - 1 &&
                ...
                // tool.
                const toolContentSlice = assistantMessage.slice(currentToolUseStart, // From after the tool opening tag.
                ...
                if (currentCharIndex >= tag.length - 1 &&
                    ...
                    if (currentTextContent) {
                        currentTextContent.content = assistantMessage
                            .slice(currentTextContentStart, // From where text started.
                        ...
                        const potentialText = assistantMessage
                            .slice(currentTextContentStart, // From where text *might* have started.
                        currentCharIndex - tag.length + 1)
                            .trim();
...
//# sourceMappingURL=parseAssistantMessageV2.js.map