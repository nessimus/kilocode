...
import { newTaskToolResponse, newRuleToolResponse, reportBugToolResponse, condenseToolResponse, } from "../prompts/commands";
 ...
 */
export async function parseKiloSlashCommands(text, localWorkflowToggles, globalWorkflowToggles) {
