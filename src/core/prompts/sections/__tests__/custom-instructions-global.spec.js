...
const { mockHomedir, mockStat, mockReadFile, mockReaddir, mockGetRooDirectoriesForCwd, mockGetGlobalRooDirectory } = vi.hoisted(() => ({
    mockHomedir: vi.fn(),
    mockStat: vi.fn(),
    mockReadFile: vi.fn(),
    mockReaddir: vi.fn(),
    ...
    describe("loadRuleFiles", () => {
        it("should load global rules only when project rules do not exist", async () => {
            ...
            mockReaddir.mockResolvedValueOnce([
                { name: "rules.md", isFile: () => true, isSymbolicLink: () => false },
            ]);
        ...
        it("should merge global and project rules with project rules after global", async () => {
            ...
            mockReaddir
                .mockResolvedValueOnce([{ name: "global.md", isFile: () => true, isSymbolicLink: () => false }])
                .mockResolvedValueOnce([{ name: "project.md", isFile: () => true, isSymbolicLink: () => false }]);
            // Mock file reading
    ...
    describe("addCustomInstructions mode-specific rules", () => {
        it("should load global and project mode-specific rules", async () => {
            ...
            mockReaddir
                ...
                { name: "global-mode.md", isFile: () => true, isSymbolicLink: () => false },
            ])
                .mockResolvedValueOnce([
                { name: "project-mode.md", isFile: () => true, isSymbolicLink: () => false },
            ]);
...
//# sourceMappingURL=custom-instructions-global.spec.js.map