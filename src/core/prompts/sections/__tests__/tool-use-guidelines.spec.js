...
describe("getToolUseGuidelinesSection", () => {
    ...
    describe("when codebase_search is available", () => {
        it("should include codebase_search first enforcement", () => {
            ...
            expect(guidelines).toContain("CRITICAL: For ANY exploration of code you haven't examined yet in this conversation, you MUST use the `codebase_search` tool FIRST");
            expect(guidelines).toContain("before any other search or file exploration tools");
            expect(guidelines).toContain("semantic search to find relevant code based on meaning rather than just keywords");
        });
    ...
    describe("when codebase_search is not available", () => {
        it("should not include codebase_search enforcement", () => {
            ...
            expect(guidelines).not.toContain("CRITICAL: For ANY exploration of code you haven't examined yet in this conversation, you MUST use the `codebase_search` tool FIRST");
...
//# sourceMappingURL=tool-use-guidelines.spec.js.map