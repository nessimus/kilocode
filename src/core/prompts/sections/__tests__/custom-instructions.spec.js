...
describe("loadRuleFiles", () => {
    ...
    it("should use .kilocode/rules/ directory when it exists and has files", async () => {
        ...
        statMock.mockImplementation((path) => {
            ...
            if (normalizedPath.includes("/fake/path/.kilocode/rules/file1.txt") ||
        ...
        const result = await loadRuleFiles("/fake/path");
        const expectedPath1 = process.platform === "win32"
            ? "\\fake\\path\\.kilocode\\rules\\file1.txt"
            : "/fake/path/.kilocode/rules/file1.txt";
        const expectedPath2 = process.platform === "win32"
        ...
        const expectedFile1Path = process.platform === "win32"
            ? "\\fake\\path\\.kilocode\\rules\\file1.txt"
            : "/fake/path/.kilocode/rules/file1.txt";
        const expectedFile2Path = process.platform === "win32"
            ? "\\fake\\path\\.kilocode\\rules\\file2.txt"
            : "/fake/path/.kilocode/rules/file2.txt";
    ...
    it("should read files from nested subdirectories in .kilocode/rules/", async () => {
        ...
        const expectedRootPath = process.platform === "win32"
            ? "\\fake\\path\\.kilocode\\rules\\root.txt"
            : "/fake/path/.kilocode/rules/root.txt";
        const expectedNested1Path = process.platform === "win32"
            ? "\\fake\\path\\.kilocode\\rules\\subdir\\nested1.txt"
            : "/fake/path/.kilocode/rules/subdir/nested1.txt";
        const expectedNested2Path = process.platform === "win32"
        ...
        const expectedRootPath2 = process.platform === "win32"
            ? "\\fake\\path\\.kilocode\\rules\\root.txt"
            : "/fake/path/.kilocode/rules/root.txt";
        const expectedNested1Path2 = process.platform === "win32"
            ? "\\fake\\path\\.kilocode\\rules\\subdir\\nested1.txt"
            : "/fake/path/.kilocode/rules/subdir/nested1.txt";
        const expectedNested2Path2 = process.platform === "win32"
            ? "\\fake\\path\\.kilocode\\rules\\subdir\\subdir2\\nested2.txt"
            : "/fake/path/.kilocode/rules/subdir/subdir2/nested2.txt";
...
describe("addCustomInstructions", () => {
    ...
    it("should combine all instruction types when provided", async () => {
        ...
        const result = await addCustomInstructions("mode instructions", "global instructions", "/fake/path", "test-mode", { language: "es" });
    ...
    it("should load AGENTS.md when settings.useAgentRules is true", async () => {
        ...
        const result = await addCustomInstructions("mode instructions", "global instructions", "/fake/path", "test-mode", {
            settings: {
    ...
    it("should handle unknown language codes properly", async () => {
        ...
        statMock.mockRejectedValueOnce({ code: "ENOENT" });
        readFileMock.mockRejectedValue({ code: "ENOENT" });
        const result = await addCustomInstructions("mode instructions", "global instructions", "/fake/path", "test-mode", { language: "xyz" });
        expect(result).toContain("Language Preference:");
    ...
    it("should use .kilocode/rules-test-mode/ directory when it exists and has files", async () => {
        ...
        statMock.mockImplementation((path) => {
            // Handle both Unix and Windows path separators
            const normalizedPath = path.toString().replace(/\\/g, "/");
            if (normalizedPath.includes("/fake/path/.kilocode/rules-test-mode/rule1.txt") ||
        ...
        const result = await addCustomInstructions("mode instructions", "global instructions", "/fake/path", "test-mode", { language: "es" });
        const expectedTestModeDir = process.platform === "win32"
            ? "\\fake\\path\\.kilocode\\rules-test-mode"
            : "/fake/path/.kilocode/rules-test-mode";
        const expectedRule1Path = process.platform === "win32"
            ? "\\fake\\path\\.kilocode\\rules-test-mode\\rule1.txt"
            : "/fake/path/.kilocode/rules-test-mode/rule1.txt";
        const expectedRule2Path = process.platform === "win32"
        ...
        const expectedTestModeDir2 = process.platform === "win32"
            ? "\\fake\\path\\.kilocode\\rules-test-mode"
            : "/fake/path/.kilocode/rules-test-mode";
        const expectedRule1Path2 = process.platform === "win32"
            ? "\\fake\\path\\.kilocode\\rules-test-mode\\rule1.txt"
            : "/fake/path/.kilocode/rules-test-mode/rule1.txt";
        const expectedRule2Path2 = process.platform === "win32"
            ? "\\fake\\path\\.kilocode\\rules-test-mode\\rule2.txt"
            : "/fake/path/.kilocode/rules-test-mode/rule2.txt";
...
describe("Rules directory reading", () => {
    it.skipIf(process.platform === "win32")("should follow symbolic links in the rules directory", async () => {
        ...
        const expectedRegularPath = process.platform === "win32"
            ? "\\fake\\path\\.kilocode\\rules\\regular.txt"
            : "/fake/path/.kilocode/rules/regular.txt";
        const expectedSymlinkPath = process.platform === "win32"
            ? "\\fake\\path\\.kilocode\\symlink-target.txt"
            : "/fake/path/.kilocode/symlink-target.txt";
        const expectedSubdirPath = process.platform === "win32"
            ? "\\fake\\path\\.kilocode\\rules\\symlink-target-dir\\subdir_link.txt"
            : "/fake/path/.kilocode/rules/symlink-target-dir/subdir_link.txt";
        const expectedNestedPath = process.platform === "win32"
    ...
    it.skipIf(process.platform === "win32")("should correctly format multiple files from directory", async () => {
        ...
        const expectedFile2Path = process.platform === "win32"
            ? "\\fake\\path\\.kilocode\\rules\\file2.txt"
            : "/fake/path/.kilocode/rules/file2.txt";
        const expectedFile3Path = process.platform === "win32"
            ? "\\fake\\path\\.kilocode\\rules\\file3.txt"
            : "/fake/path/.kilocode/rules/file3.txt";
    ...
    it("should return files in alphabetical order by filename", async () => {
        ...
        const expectedAlphaPath = process.platform === "win32" ? "\\fake\\path\\.roo\\rules\\alpha.txt" : "/fake/path/.roo/rules/alpha.txt";
        const expectedBetaPath = process.platform === "win32" ? "\\fake\\path\\.roo\\rules\\Beta.txt" : "/fake/path/.roo/rules/Beta.txt";
        const expectedZebraPath = process.platform === "win32" ? "\\fake\\path\\.roo\\rules\\zebra.txt" : "/fake/path/.roo/rules/zebra.txt";
...
//# sourceMappingURL=custom-instructions.spec.js.map