...
describe("getObjectiveSection", () => {
    ...
    describe("when codebase_search is available", () => {
        it("should include codebase_search first enforcement in thinking process", () => {
            ...
            expect(objective).toContain("for ANY exploration of code you haven't examined yet in this conversation, you MUST use the `codebase_search` tool");
...
//# sourceMappingURL=objective.spec.js.map