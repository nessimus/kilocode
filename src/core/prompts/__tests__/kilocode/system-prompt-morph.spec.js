...
customInstructionsMock.addCustomInstructions.mockImplementation(async (modeCustomInstructions, globalCustomInstructions, cwd, mode, options) => {
    const sections = [];
...
describe("SYSTEM_PROMPT", () => {
    ...
    it("should exclude traditional editing tools and include Morph instructions when morphFastApply is enabled", async () => {
        ...
        experimentsWithMorph, true, // enableMcpServerCreation
        undefined, // language
        ...
        expect(prompt).toContain("Traditional editing tools (apply_diff, write_to_file, insert_content, search_and_replace) are disabled");
    ...
    it("should include traditional editing tools and exclude edit_file when morphFastApply is disabled", async () => {
        ...
        undefined, // globalCustomInstructions
        true, // diffEnabled
        experimentsWithoutMorph, true, // enableMcpServerCreation
        undefined, // language
        undefined, // rooIgnoreInstructions
        undefined);
        ...
        expect(prompt).not.toContain("Traditional editing tools (apply_diff, write_to_file, insert_content, search_and_replace) are disabled");
    ...
    it("should use Morph editing instructions in rules section when morphFastApply is enabled", async () => {
        ...
        expect(prompt).toContain("**Morph FastApply is enabled.** You have access to the `edit_file` tool which uses a specialized model optimized for intelligent code understanding and modification.");
        expect(prompt).toContain("**ONLY use the edit_file tool for file modifications.** Traditional editing tools (apply_diff, write_to_file, insert_content, search_and_replace) are disabled in Morph mode.");
