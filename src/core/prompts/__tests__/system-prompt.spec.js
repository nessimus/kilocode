...
describe("SYSTEM_PROMPT", () => {
    ...
    it("should include browser actions when supportsComputerUse is true", async () => {
        const prompt = await SYSTEM_PROMPT(mockContext, "/test/path", true, // supportsComputerUse
        undefined, // mcpHub
        undefined, // diffStrategy
    ...
    it("should use active workplace company when interpolating companyName for file prompts", async () => {
        ...
        const clineProviderState = { workplaceState };
...
//# sourceMappingURL=system-prompt.spec.js.map