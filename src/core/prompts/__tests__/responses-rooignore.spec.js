...
describe("RooIgnore Response Formatting", () => {
    ...
    describe("formatResponse.rooIgnoreError", () => {
        ...
        it("should format error message for ignored files", () => {
            ...
            expect(errorMessage).toContain("Access to secrets/api-keys.json is blocked by the .kilocodeignore file settings");
    ...
    describe("formatResponse.formatFilesList with RooIgnoreController", () => {
        ...
        it("should format files list with lock symbols for ignored files", async () => {
            ...
            const result = formatResponse.formatFilesList(TEST_CWD, files, false, controller, true);
        ...
        it("should hide ignored files when showRooIgnoredFiles is false", async () => {
            ...
            const result = formatResponse.formatFilesList(TEST_CWD, files, false, controller, false);
        ...
        it("should handle truncation with RooIgnoreController", async () => {
            ...
            const result = formatResponse.formatFilesList(TEST_CWD, ["file1.txt", "file2.txt"], true, // didHitLimit = true
            controller, true);
        ...
        it("should handle empty file list with RooIgnoreController", async () => {
            ...
            const result = formatResponse.formatFilesList(TEST_CWD, [], false, controller, true);
