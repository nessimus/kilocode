...
describe("addCustomInstructions", () => {
    ...
    it("should generate correct prompt for architect mode", async () => {
        const prompt = await SYSTEM_PROMPT(mockContext, "/test/path", false, // supportsComputerUse
        undefined, // mcpHub
    ...
    it("should prioritize mode-specific rules for test engineer mode", async () => {
        ...
        expect(instructions).toMatchFileSnapshot("./__snapshots__/add-custom-instructions/test-engineer-mode-rules.snap");
    });
    it("should prioritize mode-specific rules for code reviewer mode", async () => {
        ...
        expect(instructions).toMatchFileSnapshot("./__snapshots__/add-custom-instructions/code-reviewer-mode-rules.snap");
    });
    ...
    it("should include custom instructions when provided", async () => {
        ...
        expect(instructions).toMatchFileSnapshot("./__snapshots__/add-custom-instructions/with-custom-instructions.snap");
    });
    it("should combine all custom instructions", async () => {
        const instructions = await addCustomInstructions("Custom test instructions", "", "/test/path", defaultModeSlug, { language: "fr" });
        expect(instructions).toMatchFileSnapshot("./__snapshots__/add-custom-instructions/combined-custom-instructions.snap");
    });
    it("should handle undefined mode-specific instructions", async () => {
        const instructions = await addCustomInstructions("", "", "/test/path", defaultModeSlug);
        expect(instructions).toMatchFileSnapshot("./__snapshots__/add-custom-instructions/undefined-mode-instructions.snap");
    });
    it("should trim mode-specific instructions", async () => {
        const instructions = await addCustomInstructions("  Custom mode instructions  ", "", "/test/path", defaultModeSlug);
        expect(instructions).toMatchFileSnapshot("./__snapshots__/add-custom-instructions/trimmed-mode-instructions.snap");
    });
    ...
    it("should combine global and mode-specific instructions", async () => {
        const instructions = await addCustomInstructions("Mode-specific instructions", "Global instructions", "/test/path", defaultModeSlug);
        expect(instructions).toMatchFileSnapshot("./__snapshots__/add-custom-instructions/global-and-mode-instructions.snap");
    });
    it("should prioritize mode-specific instructions after global ones", async () => {
        const instructions = await addCustomInstructions("Second instruction", "First instruction", "/test/path", defaultModeSlug);
        ...
        expect(instructions).toMatchFileSnapshot("./__snapshots__/add-custom-instructions/prioritized-instructions-order.snap");
    });
});
