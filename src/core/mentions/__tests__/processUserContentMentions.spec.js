...
describe("processUserContentMentions", () => {
    ...
    describe("maxReadFileLine parameter", () => {
        it("should pass maxReadFileLine to parseMentions when provided", async () => {
            ...
            expect(parseMentions).toHaveBeenCalledWith("<task>Read file with limit</task>", "/test", mockUrlContentFetcher, mockFileContextTracker, mockRooIgnoreController, false, true, // includeDiagnosticMessages
        ...
        it("should pass undefined maxReadFileLine when not provided", async () => {
            ...
            expect(parseMentions).toHaveBeenCalledWith("<task>Read file without limit</task>", "/test", mockUrlContentFetcher, mockFileContextTracker, mockRooIgnoreController, false, true, // includeDiagnosticMessages
            50, // maxDiagnosticMessages
            undefined);
        });
        it("should handle UNLIMITED_LINES constant correctly", async () => {
            ...
            expect(parseMentions).toHaveBeenCalledWith("<task>Read unlimited lines</task>", "/test", mockUrlContentFetcher, mockFileContextTracker, mockRooIgnoreController, false, true, // includeDiagnosticMessages
            50, // maxDiagnosticMessages
            -1);
        });
    });
    ...
    describe("showRooIgnoredFiles parameter", () => {
        it("should default showRooIgnoredFiles to false", async () => {
            ...
            expect(parseMentions).toHaveBeenCalledWith("<task>Test default</task>", "/test", mockUrlContentFetcher, mockFileContextTracker, undefined, false, // showRooIgnoredFiles should default to false
        ...
        it("should respect showRooIgnoredFiles when explicitly set to false", async () => {
            ...
            expect(parseMentions).toHaveBeenCalledWith("<task>Test explicit false</task>", "/test", mockUrlContentFetcher, mockFileContextTracker, undefined, false, true, // includeDiagnosticMessages
            50, // maxDiagnosticMessages
            undefined);
        });
    });
