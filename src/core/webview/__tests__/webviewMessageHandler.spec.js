...
describe("webviewMessageHandler - requestRouterModels", () => {
    ...
    it("skips LiteLLM when both config and message values are missing", async () => {
        ...
        expect(mockGetModels).not.toHaveBeenCalledWith(expect.objectContaining({
            provider: "litellm",
        }));
...
describe("webviewMessageHandler - deleteCustomMode", () => {
    ...
    it("should handle errors when deleting rules folder", async () => {
        ...
        expect(vscode.window.showErrorMessage).toHaveBeenCalledWith(t("common:errors.delete_rules_folder_failed", {
            rulesFolderPath,
            error: error.message,
        }));
