...
describe("mode-validator", () => {
    ...
    describe("validateToolUse", () => {
        it("throws error for disallowed tools in architect mode", () => {
            expect(() => validateToolUse("unknown_tool", "architect", [])).toThrow('Tool "unknown_tool" is not allowed in architect mode.');
        });
        ...
        it("throws error when tool requirement is not met", () => {
            const requirements = { apply_diff: false };
            expect(() => validateToolUse("apply_diff", codeMode, [], requirements)).toThrow('Tool "apply_diff" is not allowed in code mode.');
        });
