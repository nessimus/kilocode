...
describe("upsertSopTool", () => {
    ...
    it("creates a new document SOP in the project scope", async () => {
        ...
        await upsertSopTool(mockTask, block, mockAskApproval, mockHandleError, mockPushToolResult, mockRemoveClosingTag);
    ...
    it("creates a workflow SOP and refreshes toggles", async () => {
        ...
        expect(fs.writeFile).toHaveBeenCalledWith("/workspace/.kilocode/workflows/deploy.workflow.json", '{"nodes":[]}', "utf8");
...
//# sourceMappingURL=upsertSopTool.spec.js.map