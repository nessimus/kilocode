...
beforeEach(() => {
    ...
    executeCommandTool.mockImplementation(async (cline, block, askApproval, handleError, pushToolResult) => {
        ...
        if (ignoredFileAttemptedToAccess) {
            ...
            formatResponse.rooIgnoreError.mockReturnValue(mockRooIgnoreError);
            formatResponse.toolError.mockReturnValue("Tool error");
...
describe("executeCommandTool", () => {
    ...
    describe("Basic functionality", () => {
        it("should execute a command normally", async () => {
            ...
            // Execute
            await executeCommandTool(mockCline, mockToolUse, mockAskApproval, mockHandleError, mockPushToolResult, mockRemoveClosingTag);
            // Verify
