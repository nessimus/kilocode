...
vi.mock("../../prompts/responses", () => ({
    formatResponse: {
        toolResult: vi.fn((result) => `Tool result: ${result}`),
...
describe("useMcpToolTool", () => {
    ...
    describe("parameter validation", () => {
        it("should handle missing server_name", async () => {
            ...
            await useMcpToolTool(mockTask, block, mockAskApproval, mockHandleError, mockPushToolResult, mockRemoveClosingTag);
    ...
    describe("successful execution", () => {
        ...
        it("should handle user rejection", async () => {
            ...
            mockProviderRef.deref.mockReturnValueOnce(undefined);
...
//# sourceMappingURL=useMcpToolTool.spec.js.map