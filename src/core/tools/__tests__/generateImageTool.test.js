...
describe("generateImageTool", () => {
    ...
    describe("partial block handling", () => {
        it("should return early when block is partial", async () => {
            ...
            await generateImageTool(mockCline, partialBlock, mockAskApproval, mockHandleError, mockPushToolResult, mockRemoveClosingTag);
        ...
        it("should process when block is not partial", async () => {
            ...
            await generateImageTool(mockCline, completeBlock, mockAskApproval, mockHandleError, mockPushToolResult, mockRemoveClosingTag);
    ...
    describe("missing parameters", () => {
        it("should handle missing prompt parameter", async () => {
            ...
            await generateImageTool(mockCline, block, mockAskApproval, mockHandleError, mockPushToolResult, mockRemoveClosingTag);
    ...
    describe("experiment validation", () => {
        it("should error when image generation experiment is disabled", async () => {
            ...
            await generateImageTool(mockCline, block, mockAskApproval, mockHandleError, mockPushToolResult, mockRemoveClosingTag);
            expect(mockPushToolResult).toHaveBeenCalledWith(formatResponse.toolError("Image generation is an experimental feature that must be enabled in settings. Please enable 'Image Generation' in the Experimental Settings section."));
        });
    });
