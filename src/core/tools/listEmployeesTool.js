...
export async function listEmployeesTool(cline, block, askApproval, handleError, pushToolResult, removeClosingTag) {
    ...
    try {
        ...
        await handleError("list employees", error);
    }
}
//# sourceMappingURL=listEmployeesTool.js.map