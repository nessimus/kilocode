...
export async function listCompaniesTool(cline, block, askApproval, handleError, pushToolResult, removeClosingTag) {
    ...
    try {
        ...
        await handleError("list companies", error);
    }
}
//# sourceMappingURL=listCompaniesTool.js.map