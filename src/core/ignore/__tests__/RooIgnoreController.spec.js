...
describe("RooIgnoreController", () => {
    ...
    describe("initialization", () => {
        ...
        it("should set up file watcher for .kilocodeignore changes", async () => {
            ...
            expect(vscode.workspace.createFileSystemWatcher).toHaveBeenCalledWith(expect.objectContaining({
                base: TEST_CWD,
    ...
    describe("validateCommand", () => {
        ...
        it("should handle command arguments and flags correctly", () => {
            ...
            expect(controller.validateCommand("grep pattern src/app.ts node_modules/index.js")).toBe("node_modules/index.js");
            ...
            expect(controller.validateCommand("Select-String -Path secrets/api-keys.json -Pattern key")).toBe("secrets/api-keys.json");
        });
        /**
...
//# sourceMappingURL=RooIgnoreController.spec.js.map