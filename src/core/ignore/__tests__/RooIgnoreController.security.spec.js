...
describe("RooIgnoreController Security Tests", () => {
    ...
    beforeEach(async () => {
        ...
        vi.clearAllMocks();
        // Setup mocks
        mockFileExists = fileExistsAtPath;
    ...
    describe("validateCommand security", () => {
        ...
        it("should block PowerShell file reading commands accessing ignored files", () => {
            // Simple Get-Content
            expect(controller.validateCommand("Get-Content node_modules/package.json")).toBe("node_modules/package.json");
            // With parameters
            ...
            expect(controller.validateCommand("Select-String -Pattern 'password' -Path private/config.json")).toBe("private/config.json");
            ...
            expect(controller.validateCommand("Get-Content -Path node_modules/package.json")).toBe("node_modules/package.json");
        });
        /**
        ...
        it("should handle complex commands with special characters", () => {
            ...
            expect(controller.validateCommand("grep pattern secrets/file-with-dashes.json")).toBe("secrets/file-with-dashes.json");
            expect(controller.validateCommand("less private/file_with_underscores.md")).toBe("private/file_with_underscores.md");
...
//# sourceMappingURL=RooIgnoreController.security.spec.js.map