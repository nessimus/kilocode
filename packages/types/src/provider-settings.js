...
import { anthropicModels, bedrockModels, cerebrasModels, chutesModels, claudeCodeModels, deepSeekModels, doubaoModels, featherlessModels, fireworksModels, geminiModels, groqModels, ioIntelligenceModels, mistralModels, moonshotModels, openAiNativeModels, qwenCodeModels, rooModels, sambaNovaModels, vertexModels, vscodeLlmModels, xaiModels, internationalZAiModels, } from "./providers/index.js";
/**
 * ProviderName
 */
...
const baseProviderSettingsSchema = z.object({
    ...
    outerGateNotionToken: z.string().optional(),
    outerGateMiroToken: z.string().optional(),
    // Model reasoning.
...
export const ANTHROPIC_STYLE_PROVIDERS = ["anthropic", "claude-code", "bedrock"];
